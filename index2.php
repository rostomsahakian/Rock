...
$category = $query_string[1];
$gender = $query_string[2];
$brand = $query_string[3];
$model_number = $query_string[4];
...
$page = ($page_name) ? $page_name : $brand;
var_dump($page);
