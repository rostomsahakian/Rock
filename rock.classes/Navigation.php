        ...
        ?>
            ...
            <ul>
                ...
                foreach ($pages[$i] as $page) {
                    if ($page['type'] == 0 || $page['type'] == "0" || $page['type'] == 1 || $page['type'] == "1" || $page['type'] == 3 || $page['type'] == "3" || $page['type'] == 5 || $page['type'] == "5") {
                        ?>
                        <li id="page_<?= $page['id'] ?>">
                            <a href="<?= ($page[]&&isset($url)?$url:"#") ?>" ><?= htmlspecialchars($page['name']) ?></a>
